...
class HBNBCommand(cmd.Cmd):
    ...
    def do_nothing(self, arg):
        """ Does nothing when the console is imported """
        pass

    def do_quit(self, arg):
        """saves the data safely and closes the program"""
        return True

    def do_EOF(self, arg):
        """saves the data safely and closes the program
when user input CTRL + D
"""
        print("")
        return True

    def emptyline(self):
        """overrides empty line method """
        pass
...
"""
        ...
        if token[0] in HBNBCommand.my_dict.key():
            for key in objects_dict:
                if token[0] in key:
                    my_json.append(str(objects_dict[key]))
            print(json.dumps(my_json))
...
"""
    ...
    def default(self, arg):
        ...
        if(command == "update" and values[1].split("(")[1][-2] == "{"):
            ...
            inputs[0] = shlex.spit(inputs[0])[0]
