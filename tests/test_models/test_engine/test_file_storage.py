...
class TestFileStorageClass(unittest.TestCase):
    """
TestFileStorage test of suit for engine
...
"""
    ...
    def test_pep8(self):
        """test base and test_base for pep8 comformance"""
    ...
    def test_empty_reload(self):
        ...
        my_obj.reload()
        my_dict2 = my_obj.all()
        self.assertTue(my_dict2 == my_dict1)
